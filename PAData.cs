...
namespace PA
{
    public readonly partial struct PAData
    {
        ...
        [LibraryImport("pa")]
        PAResult PADataOperatorLess(PAData one, PAData other);
        [LibraryImport("pa")]
        PAResult PADataOperatorEqual(PAData one,PAData other);
        [LibraryImport("pa")]
        PAResult PADataOperatorGreater(PAData one,PAData other);
        [LibraryImport("pa")]
