...
namespace PA
{
    public readonly partial struct PAList
    {
        ...
        [LibraryImport("pa")]
        public static partial PAResult PAListOperatorEqual(PAList one, PAList other);
        [LibraryImport("pa")]
        public static partial PAResult PAListOperatorNotEqual(PAList one, PAList other);
    }
}
